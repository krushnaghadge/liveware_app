            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item "> <a wire:navigate class="nav-link" href="{{ route('page', ['id' => 1]) }}">About Us</a></li>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a wire:navigate href="{{ route('page', ['id' => 1]) }}">About Us</a>
                            </li>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="list-inline-item me-4"><a class="text-black" wire:navigate
                                    href="{{ route('page', ['id' => 2]) }}">Privacy Policy</a>
                            </li>
                            <li class="list-inline-item me-4"><a wire:navigate class="text-black" href="{{ route('page', ['id' => 3]) }}">Terms &amp;
                                    Conditions</a>
                            </li>
                        </ul>
                    </div>
