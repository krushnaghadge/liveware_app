                                        ...
                                        <article class="blog-post">
                                            ...
                                            <div class="pt-4">
                                                ...
                                                <h2 class="h4"><a class="text-black" wire:navigate
                                                        href="{{ route('blogDetail', ['id' => $article->id]) }}">{{ $article->title }}</a></h2>
                                                <p>{{ $article->short_desc }}</p> <a wire:navigate href="{{ route('blogDetail', ['id' => $article->id]) }}"
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            @if ($categories->IsNotEmpty())
                                @foreach ($categories as $category)
                                    <li><a wire:navigate
                                            href="{{ route('blog') . '?categorySlugs=' . $category->slug }}">{{ $category->name }}
                                            <small class="ml-auto">({{ $category->articles_count }})</small></a>
                                    </li>
                                @endforeach
                                    ...
                                    <li class="d-flex widget-post align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="h6 mb-0"><a class="text-black" wire:navigate
                                                    href="{{ route('blogDetail', ['id' => $latestArticle->id]) }}">{{ $latestArticle->title }}</a>
                                            </h5>
